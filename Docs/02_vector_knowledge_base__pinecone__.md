...
Welcome back! In [Chapter 1: AI Chat RAG Workflow](01_ai_chat_rag_workflow_.md), we established the two main phases of our AI system: **Ingestion** (putting knowledge in) and **RAG** (getting answers out).
